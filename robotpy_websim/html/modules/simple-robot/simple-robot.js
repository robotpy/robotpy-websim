...
$(function() {
	...
	function create_iomodule() {
		...
		return sim.add_iomodule('simple-robot', new function() {
	...
	// Load content
	$.get('modules/simple-robot/simple-robot.html', function(content) {
		
		// Add the content
		$('<div id="simple-robot">' + content + '</div>').appendTo('body');
		...
		// Add the css
		sim.add_css('modules/simple-robot/simple-robot.css');
		...
		config_modal.add_category('simple-robot', 'Simple Robot', form, 1);
		config_modal.add_update_listener('simple-robot', true, function(simple_robot) {
				
			var visible = simple_robot[0].visible;
