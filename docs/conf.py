...
htmlhelp_basename = 'robotpy_websimdoc'
...
latex_documents = [
  ('index', 'robotpy_websim.tex', 'robotpy-websim Documentation',
...
man_pages = [
    ('index', 'robotpy_websim', 'robotpy-websim Documentation',
...
texinfo_documents = [
  ('index', 'robotpy_websim', 'robotpy-websim Documentation',
   'RobotPy development team', 'robotpy-websim', 'One line description of project.',
   'Miscellaneous'),
]
